    ...
    class Error
    {
        public void ListaError(int opc,String reservada, int linea) ///nota: el parametro [reservada] llegan varibales o palabras reservadas
        {
            switch (opc)
            {
               ...
               case 9: { Console.WriteLine("No existe la variable (" + reservada + ") declarada" + " linea " + linea); Console.Read(); } break;
               case 10:{ Console.WriteLine("Error de sintaxis en asignacion en la variable (" + reservada + ") No es compatible con el tipo de dato boleano: Linea " + linea); Console.Read(); } break;
               case 11:{ Console.WriteLine("Error, no existe la palabra  (" + reservada + ") Linea " + linea); Console.Read(); } break;
               case 12:{ Console.WriteLine("Error de sintaxis en la variable {"+reservada+"} linea "+linea); Console.Read(); }break;
